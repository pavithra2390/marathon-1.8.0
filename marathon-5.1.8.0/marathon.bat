...
start javaw -Xmx512m -Dfile.encoding=utf8 -cp "%MARATHONHOME%/UserLibs/*;%MARATHON_EXTRA_JARS%;%MARATHONHOME%/marathon-5.1.8.0.jar" net.sourceforge.marathon.Main %1 %2 %3 %4 %5 %6 %7 %8 %9
goto end
:batch
ECHO changing the console to UTF8
chcp 65001
java -Xmx512m -Dfile.encoding=utf8 -cp "%MARATHONHOME%/UserLibs/*;%MARATHON_EXTRA_JARS%;%MARATHONHOME%/marathon-5.1.8.0.jar" net.sourceforge.marathon.Main %1 %2 %3 %4 %5 %6 %7 %8 %9
goto :end
