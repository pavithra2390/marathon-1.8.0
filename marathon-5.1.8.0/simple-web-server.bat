...
start javaw -Xmx512m -Dfile.encoding=utf8 -cp "%MARATHONHOME%/marathon-5.1.8.0.jar"  net.sourceforge.marathon.SimpleWebServer %1 %2 %3 %4 %5 %6 %7 %8 %9
goto end
:batch
ECHO Changing the console code page to utf8
CHCP 65001
java -Xmx512m -Dfile.encoding=utf8 -cp "%MARATHONHOME%/marathon-5.1.8.0.jar"  net.sourceforge.marathon.SimpleWebServer %1 %2 %3 %4 %5 %6 %7 %8 %9
goto :end
